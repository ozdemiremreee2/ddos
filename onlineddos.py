...
def usage():
	print '---------------------------------------------------'
	print 'to attack:'
        print '#Windows: onlineddos.py http://www.exemplo.com'
        print '#Linux: python onlineddos.py http://www.exemplo.com'
	print "\a"
print \
"""                          
   ...
   ###########################################################################        
   #                MMMMMMMMMMMMMMMMMMMMMMMBBBBBBBBBBBBBBBBBBBBBB            # 
   #                                                                         #
   #                MMMMMMMMMMMMMMMMMMMMMMMBBBBBBBBBBBBBBBBBBBBBB            #
   #                                                                         # 
   #                          Script By IboCanReyis.tk                       #
   #                     OnlineDDOS.TK Website Attack Scripts                #
   #                                                                         #
   #                                                                         #  
   #                                                                         #
   ###########################################################################...
